namespace ChessLogic
{
    public class Board
    {
        ...
        public bool InsufficientMaterial()
        {
            ...
            return IsKingVKing(counting) || IsKingBishopVKingBishop(counting) || IsKingKnightVKing(counting) || IsBishopVKing(counting);
        }
        ...
        private static bool IsBishopVKing(Counting counting)
        {
